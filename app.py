...
def save():
    ...
    file_handler = open('C:\Users\Public\Documents\python\Projects\P118\PRO-C118-Project-Boilerplate-main\static\assets\datafiles\updated_product_dataset.csv',"a")
